...
mkdir --mode=700 "${XDG_CONFIG_HOME}/credstore.encrypted"

# environment.d contents
ln -sfbr --suffix=.bak --target-directory="${XDG_CONFIG_HOME}/environment.d" ./environment.d/*.conf
...
ln -sfbr --suffix=.bak --target-directory="${XDG_CONFIG_HOME}" ./xdg-desktop-portal
ln -sfbr --suffix=.bak --target-directory="${XDG_CONFIG_HOME}" ./zed
